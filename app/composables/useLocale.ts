...
const uiCopy: Record<Locale, CopyTree> = {
  en: {
    ...
    'contact.telegram.open': 'Open the draft in Telegram',
    'contact.telegram.hint': 'Your answers are collected into one message — Telegram opens it as a draft so you only press send.',
